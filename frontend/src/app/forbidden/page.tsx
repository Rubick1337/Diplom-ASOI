...
const ERROR_LINES = [
    { delay: 0,    text: '$ goosecode check-access',               type: 'cmd'   },
    { delay: 400,  text: 'Verifying role...',                       type: 'info'  },
    { delay: 900,  text: '',                                        type: 'gap'   },
    { delay: 1100, text: '✖ AccessError: Permission denied',        type: 'err'   },
    { delay: 1400, text: '  at Auth.guard (middleware.js:403)',     type: 'trace' },
    { delay: 1600, text: '  at GooseCode.request (app.js:1)',       type: 'trace' },
    { delay: 1900, text: '',                                        type: 'gap'   },
    { delay: 2100, text: '  exit code 403',                         type: 'exit'  },
];
...
export default function ForbiddenPage() {
    ...
    return (
        <div className="nf-page">
            <div className="nf-code" aria-label="403">
                <span className="nf-code__main" data-text="403">403</span>
            </div>
            ...
            <h1 className="nf-title">Доступ запрещён</h1>
            ...
            <div className="nf-actions">
                ...
                <button className="nf-btn nf-btn--ghost" onClick={() => router.back()}>
                    <svg width="15" height="15" viewBox="0 0 24 24" fill="none">
